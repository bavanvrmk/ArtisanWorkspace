...
from api.routes import auth, khata, schemes, passport, vision_mock, voice_mock, pricing_mock, guide
...
app.include_router(guide.router, prefix="/api/guide", tags=["Voice guide"])
...
def root():
    return {
        ...
        "workstreams": {
            ...
            "guide": "/api/guide/prompt/hi/welcome",
        },
    }
